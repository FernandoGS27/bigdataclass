...
max_total_vendido=total_vendido.select(max(col("Total_Vendido"))).collect()[0][0]
caja_mas_ventas = max_total_vendido.filter(total_vendido.Total_Vendido==max_total_vendido).select("numero_caja").collect()[0][0]
