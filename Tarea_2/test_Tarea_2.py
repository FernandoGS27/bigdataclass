...
def test_calcular_metricas(spark_session):
    ...
    cajas_data = [(1,"A",4,100.0), (1,"B",3,200.0),(1,"C",2,200.0),(2,"D",1,1000.0), (2,"E",3,700.0), (3,"A",1,100.0),(3,"C",4,200.0),(3,"D",6,1000.0),(3,"E",3,700.0),(4,"B",2,300.0),(4,"C",4,300.0)]
    cajas_ds = spark_session.createDataFrame(cajas_data, ['numero_caja','Nombre','Cantidad','Precio_Unitario'])
    ...
    total_ventas_data = [(1,500.0),(2,1700.0),(3,2000.0),(4,600.0)]
    ...
    expected_ds = spark_session.createDataFrame([("caja_con_mas_ventas","3"),("caja_con_menos_ventas","1"),("percentil_25_por_caja","500.0"),("percentil_50_por_caja","600.0"),
